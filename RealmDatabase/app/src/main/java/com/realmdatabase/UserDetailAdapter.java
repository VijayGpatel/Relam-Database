...
public class UserDetailAdapter extends RecyclerView.Adapter<UserDetailAdapter.ViewHolder> {
    ...
    UserDetailAdapter(Context context, List<UserDetail> userDetails) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        holder.txtId.setText("" + (position+1)); //userDetails.get(position).getId() + ""
        ...
        holder.imgDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((BaseActivity) mcontext).deleteByUserId(userDetails.get(position).getEmail());
            ...
            public void onClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // update user data
                        ((BaseActivity) mcontext).updateUserDetailById(userDetails.get(position).getId(), edtName.getText().toString(), edtEmail.getText().toString(), edtPhone.getText().toString(), edtCity.getText().toString(), edtState.getText().toString());
